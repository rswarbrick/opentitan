...
`include "chip_sw_rram_rma_unlocked_vseq.sv"
...
`include "chip_sw_keymgr_dpe_sideload_kmac_vseq.sv"
`include "chip_sw_keymgr_dpe_sideload_aes_vseq.sv"
`include "chip_sw_keymgr_dpe_sideload_otbn_vseq.sv"
